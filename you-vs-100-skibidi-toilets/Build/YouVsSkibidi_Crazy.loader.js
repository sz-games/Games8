function createUnityInstance(t, n, d) {
    ...
    function r(e) {
        ...
        (n += "\n" + (r = r.startsWith(n) ? r.substring(n.length) : r).trim()) && m.stackTraceRegExp && m.stackTraceRegExp.test(n) && T(n, e.filename || t && (t.fileName || t.sourceURL) || "", e.lineno || t && (t.lineNumber || t.line) || 0)
    }
    function e(e, t, n) {
        var r = e[t];
    ...
    function(o, a) {
        var e, t, i = w.getInstance(), s = U("string" == typeof o ? o : o.url), d = {
            enabled: (e = s,
        ...
        function c(n, r) {
            return fetch(n, r).then(function(e) {
                ...
                i.updateRequestMetaData(d.metaData).then(function() {
                    D("'" + d.metaData.url + "' successfully revalidated and served from the indexedDB cache")
                }).catch(function(e) {
                    D("'" + d.metaData.url + "' successfully revalidated but not stored in the indexedDB cache due to the error: " + e)
                }),
                ...
                C(e, r.onProgress, r.enableStreamingDownload).then(function(e) {
                    ...
                    Promise.all([i.storeRequest(n, t), i.updateRequestMetaData(d.metaData)]).then(function() {
                        D("'" + s + "' successfully downloaded and stored in the indexedDB cache")
                    }).catch(function(e) {
                        D("'" + s + "' successfully downloaded but not stored in the indexedDB cache due to the error: " + e)
                    }),
                    e
                })) : (D("'" + s + "' request failed with status: " + e.status + " " + e.statusText),
        ...
        d.enabled ? i.loadRequest(s).then(function(e) {
            ...
            i.updateRequestMetaData(r).then(function() {
                D("'" + d.metaData.url + "' served from the indexedDB cache without revalidation")
            }),
            ...
            return D("Failed to load '" + d.metaData.url + "' from indexedDB cache due to the error: " + e),
            y(o, a)
        }) : y(o, a)
    }
    );
    ...
    function x() {
        ...
        n(m[t], {
            ...
            var t, n, r, o, a, i;
            return k.gzip.hasUnityMarker(e.parsedBody) && (t = ["gzip", "gzip"]),
            (t = k.br.hasUnityMarker(e.parsedBody) ? ["brotli", "br"] : t) && (n = e.headers.get("Content-Type"),
    ...
    return new Promise(function(e, t) {
        ...
        x()) : t("Your browser does not support WebAssembly.") : t("Your browser does not support WebGL.")
    }
    )
}
